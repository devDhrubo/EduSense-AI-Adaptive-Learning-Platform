...
export const RadarIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <polygon
      points="12 2 19.5 6 19.5 18 12 22 4.5 18 4.5 6 12 2"
      opacity="0.4"
    ></polygon>
...
export const RocketIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.09-3.1a2.2 2.2 0 0 0-3.1-3.1c-.8.6-2.26.61-3.1.09z"
      opacity="0.4"
    />
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.5a3.5 3.5 0 0 0-3.5 3.5v3a3.5 3.5 0 0 0 3.5 3.5h.5a4.5 4.5 0 0 0 4.5 4.5 4.5 4.5 0 0 0 4.5-4.5h.5a3.5 3.5 0 0 0 3.5-3.5v-3a3.5 3.5 0 0 0-3.5-3.5v-.5A4.5 4.5 0 0 0 12 2z"
      opacity="0.4"
    ></path>
